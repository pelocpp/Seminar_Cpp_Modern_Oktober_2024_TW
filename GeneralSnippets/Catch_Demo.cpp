...
TEST_CASE("More Factorials are computed", "[more_factorials]") {
...
TEMPLATE_TEST_CASE("simple vectors", "[simple_template]", int, std::string, (std::tuple<int, float>)) {
...
TEST_CASE("Bugs, bugs, bugs", "[Bug]")
{
    ...
    REQUIRE_THAT(str, match_expression1);
}
