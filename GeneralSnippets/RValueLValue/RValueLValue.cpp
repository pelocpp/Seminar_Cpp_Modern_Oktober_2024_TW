...
namespace LValueRValue {
    ...
    static void test01() {
        ...
        std::string a = "Hello";
        std::string b = " World";
        std::string c = a + b; // tmp. Objekt // anonymes Objekt

        // Referenz: benanntes Objekt // NAME // Alias

        sayHello(a);

        sayHello(a + b);  // +  Aneinanderhängen
    ...
    static void helper(std::string&& message) {
        ...
        // b) sayHello (&):  message hat einen Namen                                                    // sayHello(std::move(message));    // casting an lvalue to an rvalue
    }
